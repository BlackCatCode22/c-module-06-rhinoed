...
Frame::Frame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title), zoo() {
    ...
    wxButton *processAnimalsButton = new wxButton(panel, ID_Process, "Process Animals", wxPoint(350, 238), wxSize(150, 50));
    wxButton *generateReportButton = new wxButton(panel, ID_GenerateReport, "Generate Report", wxPoint(350, 500), wxSize(150, 50));
